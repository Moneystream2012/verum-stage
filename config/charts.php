...
return [
    ...
    */
    ...
    'default' => [
        ...
        'height' => 350, // 0 Means it will take 100% of the division height.
        ...
        'background_color' => '#fff', // The chart division background color.
        ...
        'loader' => [
            ...
            'color' => '#357ebd', // Determines the default loader color.
        ],
    ],
