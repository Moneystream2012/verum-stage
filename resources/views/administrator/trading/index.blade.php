	...
	<div class="container-fluid-md">
		<div class="panel panel-default">
			<div class="panel-heading clearfix">
                <div class="pull-left">
                    <h4 class="panel-title padding-sm">Items Trading</h4>
                </div>
                <div class="pull-right">
                    <a href="{{route('administrator.trading.update')}}" class="btn btn-link"><i class="fa fa-wrench"></i> Настройка процента</a>
                </div>
            </div>
